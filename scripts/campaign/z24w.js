//planet z24we
const z24w = extend(PlanetGenerator, {
    rawHeight(position){
    ...
    generate(tiles, sec){
        ...
        const Room = {
            ...
            connect(to){
                ...
                z24w.brush(z24w.pathfind(this.x, this.y, to.x, to.y, tile => (tile.solid() ? 5 : 0) + z24w.noiseOct(tile.x, tile.y, 1, 1, 1 / nscl) * 60, Astar.manhattan), stroke);
            }
        };
...
z24w.rid = new Packages.arc.util.noise.RidgedPerlin(1, 2);
z24w.basegen = new BaseGenerator();
z24w.scl = 5;
z24w.waterOffset = 0.07;
z24w.water = 2 / z24w.arr[0].length;

const z24we = new JavaAdapter(Planet, {}, "z24w", Planets.sun, 3, 1);
